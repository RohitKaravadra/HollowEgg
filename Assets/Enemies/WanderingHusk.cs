...
public class WanderingHusk : MonoBehaviour, IDamageable
{
    ...
    private void OnDrawGizmos()
    {
        ...
        float dir = _PetrolStrategy.Dir == 0 ? 1 : _PetrolStrategy.Dir; // ensure dir is set

        Vector2 point = (Vector2)transform.position + _PetrolStrategy.Offset;
        Gizmos.DrawLine(point, point + dir * _PetrolStrategy.SideCheckDistance * Vector2.right);

        point += dir * _PetrolStrategy.SideCheckDistance * Vector2.right;
